...
def inverse_kin(coordenadas):
    ...
    theta = [0.1552, 0.1368, 0.1917] #l1,l2 e l3


    f = directf(np.array([q_1,q_2,q_3]),theta)


    p_desire = np.array([coordenadas[0], coordenadas[1], coordenadas[2]])
    ...
    return [sol.value(q_1),sol.value(q_2),sol.value(q_3)]
